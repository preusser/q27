set TOP  vc707_queens_uart
set PART xc7vx485t-2-ffg1761

read_vhdl -library PoC ../../PoC/common/my_config_VC707.vhdl
...
set_property IOSTANDARD  LVCMOS18 [get_ports rts_n]
set_property PACKAGE_PIN AT32     [get_ports rts_n]
set_property IOSTANDARD  LVCMOS18 [get_ports cts_n]
set_property PACKAGE_PIN AR34     [get_ports cts_n]

# Fan
set_property IOSTANDARD  LVCMOS18 [get_ports VC707_FanControl_PWM]
